...
- (void)addYueDuLiang{
    ...
    item1.itemColor = RGBA(60, 91, 170, 1);
...
//    item2.itemColor = RGBA(231, 133, 62, 0.5);
    ...
    item11.itemColor = RGBA(60, 91, 170, 1);
    ...
    item22.itemColor = RGBA(231, 133, 62, 1);
...
//    item3.itemColor = RGBA(156, 133, 62, 0.5);
    ...
    if (_readNum.myMonthReadNum.count<6) {
        for (int i = 0; i<_readNum.myMonthReadNum.count + 5; i++) {
            if (i<_readNum.myMonthReadNum.count) {
                ...
                if ([mon integerValue]+i >= 13) {
                    [montharray addObject:[NSString stringWithFormat:@"%ld月",b]];
                    b++;
                }else{
                    NSInteger yue = [mon integerValue]+i;
    ...
    his1.MaxYvalue = [_readNum.maxBookNum integerValue];
    his1.Ynumber = 10;
...
//    }
        ...
        for (int i = 0; i<_literacy.myMonthLiteracy.count + 5; i++) {
            if (i<_literacy.myMonthLiteracy.count) {
                ...
                if ([mon integerValue]+i >= 13) {
                    ...
                    AcherSzScNRModel *m = _literacy.myMonthLiteracy[0];
                    NSInteger yue = [m.month integerValue]+i;
                    [montharray addObject:[NSString stringWithFormat:@"%ld月",yue]];
                }
    ...
    his.MaxYvalue = _literacy.maxLiteracyNum;
    his.Ynumber = 10;
    his.histArray = @[item1];
...
- (void)addShiZC{
    ...
    his.FormColor = RGB(0x33, 0x33, 0x33);
    his.Xcoordinates = montharray;
    his.MaxYvalue = _glossary.maxGlossaryNum;
    his.Ynumber = 10;
    his.histArray = @[item1];
